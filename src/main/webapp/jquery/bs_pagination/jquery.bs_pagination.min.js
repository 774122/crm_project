...
var b={init:function(g){var h=this;
return this.each(function(){var C=h.data(d);
if(typeof C=="undefined"){var E="3";
if(g.hasOwnProperty("bootstrap_version")&&g.bootstrap_version=="2"){E="2"}var v=b.getDefaults.call(h,E);
C=e.extend({},v,g)}else{C=e.extend({},C,g)}if(C.totalRows==0){C.totalRows=C.totalPages*C.rowsPerPage}h.data(d,C);
h.unbind("onChangePage").bind("onChangePage",C.onChangePage);h.unbind("onLoad").bind("onLoad",C.onLoad);
